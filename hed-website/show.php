...
<body>
	...
	<?php
		...
		*/
		...
		if ( isset($_SESSION['user']) ){
				...
				#for every data print out this
			{
				echo "<tr>
						...
						<td> <a href='level-1-homepage.php'> Return </a> </td>
		...
		//checking the session
			...
			//else if user is level 2, show this instead:
				echo "<table>
					<tr>
						<th>Home</th>
					</tr>";
			...
			//else do not let access to page and force login. 
				echo "<table>
					<tr>
	...
	//if no session is active, force user to login. 
		echo "<table>
					<tr>
						<th>Notice - Must Login</th>
					</tr>";
